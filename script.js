const translations = {
  ...
  'Ordering the right paving product should feel simple.': 'طلب منتج الرصف المناسب يجب أن يكون سهلاً.',
  'Tell us which Interlock or Kerbstone you need, the size, quantity and delivery location. We will help you confirm the right order details.': 'أخبرنا بنوع الإنترلوك أو الكربستون والمقاس والكمية وموقع التوصيل، وسنساعدك في تأكيد تفاصيل الطلب المناسبة.',
  'Speak to the team': 'تواصل مع الفريق',
  'A focused product range': 'منتجات محددة وواضحة',
  ...
  'Message +968 9417 8871 on WhatsApp with the Interlock or Kerbstone product, size, quantity and delivery location.': 'راسل الرقم 9417 8871 968+ عبر واتساب، وأرسل منتج الإنترلوك أو الكربستون والمقاس والكمية وموقع التوصيل.',
